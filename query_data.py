...
prompt = PromptTemplate(
    ...
    give the answer based on given documents and human resources-related queries. If question is not related to given documents or Merchant trade queries, say I am not design of this question.
    {chat_history}
    {context}
...
def call_chain():
    ...
    memory = ConversationBufferWindowMemory(memory_key="chat_history", input_key="human_input", k=3)
    qna = load_qa_chain(OpenAI(temperature=0), chain_type="stuff", prompt=prompt)
    return qna
