...
async def chat(request: QueryRequest):
    ...
    """
    text = request.query
    relevant_docs = get_relevant_documents(text)
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    while True:
        try:
            ...
            relevant_docs=db.similarity_search(user_msg)
